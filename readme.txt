...
TechGasp Sound Master is a light weight and shiny clean code wordpress plugin that you need to show off and sell your soundcloud music.
...
These are the main options we packed into this extension. SoundCloud player is able to play single tracks, private tracks or full user music sets... nothing better than a nice music playlist, full control over player width and height, full control over color scheme, display the track or music set artwork and, auto-play.
...
* Play Buttons Widget (Connect and Lyrics Button)
...
* Play Dashboard Widget

* Play User Profile Widget

* Play Basic Fast Page Loading Player Widget

* Play Advanced Responsive Player Widget
* Play Advanced Player (full nine yards SoundCloud Player. Single tracks and Sets of Tracks Supported), full control over:
* Player Color
* Auto-Play
* Display User
* Display Playcount
...
* Play Private Tracks Widget
* Allows your to play your soundcloud private tracks with full control over:
* Player Color
* Auto-Play
* Display User
* Display Artwork
...
* [Advanced Version Link](https://wordpress.techgasp.com/soundcloud-master/)

**ONLINE DEMO**

* Right of the page, sidebar widget
* Inside the post, with shortcode framework v5
* [Demo Link](https://wordpress.techgasp.com/soundcloud-master/)
...
3. Visit the "Widget Page | Play Master Widgets" to configure widget settings and your template widget positions.
4. [Play Master Documentation](https://wordpress.techgasp.com/soundcloud-master-documentation)
...
= Need More Help =
* [Play Master Documentation](https://wordpress.techgasp.com/soundcloud-master-documentation)
...
= 5.0 =
* Version 5.0 contained 16 releases (5.0 to 5.0.16) please view changelog online
